...
![landing_page_rsia](https://user-images.githubusercontent.com/16396664/140909796-815239e4-a986-46ad-bbd0-4b166127bbb8.JPG)

## Demo URL

[https://landing_page_rsia.netlify.com](https://landing_page_rsia.netlify.com)
...
### To Contribute to this project, read the [Contribution Guidlines](https://github.com/realstoman/landing_page_rsia/blob/main/CONTRIBUTING.md)
...
```
git clone https://github.com/realstoman/landing_page_rsia.git
```

3. Open the project folder:

```
cd landing_page_rsia
```
...
[MIT](https://github.com/realstoman/landing_page_rsia/blob/main/LICENSE)
