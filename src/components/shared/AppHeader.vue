<template>
	...
	<!-- <nav id="nav" class="sm:container sm:mx-auto fixed top-0 left-0 w-full z-10 bg-primary-dark shadow-md"> -->
	<nav id="nav" class="sm:mx-auto fixed top-0 left-0 w-full sm:px-4 z-10 shadow-md"
		...
		<!-- <nav id="nav" class="sm:mx-auto fixed top-0 left-0 w-full z-10 bg-primary-dark shadow-md"> -->
