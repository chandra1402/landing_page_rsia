	...
	<div class="container mx-auto">
		<div class="pt-20 sm:pt-30 pb-8 mt-20 border-t-2 border-primary-light dark:border-secondary-dark">
			...
			<div class="flex flex-col justify-center items-center mb-12 sm:mb-20">
				...
				<div class="h-screen w-full card bg-white border border-gray-200 shadow-lg rounded-lg my-4 mx-auto p-4">
					<GMapMap :center="{ lat: 40.712776, lng: -74.005974 }" :zoom="12" class="h-full w-full">
						<GMapMarker :position="{ lat: 40.712776, lng: -74.005974 }" :clickable="true"
							:draggable="true" />
					</GMapMap>
				</div>
